libname Exam "/home/nayeem58470/Exam";
...
data Exam.da2835p1_c;
    set Exam.da2835p1_b;
	IF (ALLPREG = .) THEN Delete;
run;


/* Weighted Frequency Analysis for Categorical Variables */
proc surveyfreq data=Exam.da2835p1_c;
    strata STRATUM;
    cluster PSU_VAR;
    weight TRMFCTR;
    tables ALLPREG;
...
/* Weighted Frequency Analysis for Categorical Variables */
proc freq data=Exam.da2835p1_c;
    tables ALLPREG;
run;

/*Creating new categorical variables*/
data Exam.da2835p1_d;
    set Exam.da2835p1_c;
...
proc surveyfreq data=Exam.da2835p1_d;
    strata STRATUM;
    cluster PSU_VAR;
    weight TRMFCTR;
    tables Low_Birth_Wt;
...
proc surveyimpute data=Exam.da2835p1_d method=hotdeck(selection=abb)
ndonors=1 seed=773269;
var IQ2901;
output out=Exam.da2835p1_e;
run;

proc surveyfreq data=Exam.da2835p1_e;
    strata STRATUM;
    cluster PSU_VAR;
    weight TRMFCTR;
    tables IQ2901;
...
proc freq data=Exam.da2835p1_e;
    tables IQ2801;
run;

proc surveyimpute data=Exam.da2835p1_e method=hotdeck(selection=abb)
ndonors=1 seed=773269;
var IQ2801;
output out=Exam.da2835p1_f;
run;

proc freq data=Exam.da2835p1_f;
    tables IQ2801;
run;

/*Creating new categorical variables*/
data Exam.da2835p1_g;
    set Exam.da2835p1_f;

    /* Create Age categorical variable */
    if IQ2801 <= 14 then Age_cat = "<=14";
    else if  15 <= IQ2801 <= 24 then Age_cat = "15-24";
    else if IQ2801 >= 25 then Age_cat = "25/25+";

    /* Apply formats */
    format Age_cat $15.;
run;

proc surveyfreq data=Exam.da2835p1_g;
    strata STRATUM;
    cluster PSU_VAR;
    weight TRMFCTR;
    tables Age_cat;
...
proc freq data=Exam.da2835p1_g;
    tables Age_cat;
run;
...
PROC surveyFREQ data=Exam.da2835p1_g;
    TABLE I_RACETH*Low_Birth_Wt / CHISQ col;
    TABLE Age_cat*Low_Birth_Wt/ CHISQ col;
    TABLE EDUC*Low_Birth_Wt / CHISQ col;
    TABLE MARITAL1*Low_Birth_Wt / CHISQ col;
    TABLE IAQ_7*Low_Birth_Wt / CHISQ col;
    TABLE ALLPREG*Low_Birth_Wt / CHISQ col;
RUN;


PROC surveyFREQ data=Exam.da2835p1_g;
    TABLE I_RACETH*IQ2901  / CHISQ col;
    TABLE Age_cat*IQ2901 / CHISQ col;
    TABLE EDUC*IQ2901  / CHISQ col;
    TABLE MARITAL1*IQ2901  / CHISQ col;
    TABLE IAQ_7*IQ2901  / CHISQ col;
    TABLE ALLPREG*IQ2901  / CHISQ;
RUN;

/* Unadjusted Logistic Regression for Low_Birth_Wt */
proc surveylogistic data=Exam.da2835p1_g;
    strata STRATUM;
    cluster PSU_VAR;
    weight TRMFCTR;
    class I_RACETH (ref="(1) WHITE") / param=ref;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    cluster PSU_VAR;
    weight TRMFCTR;
    class Age_cat (ref="25/2") / param=ref;
    model Low_Birth_Wt (event="Yes") = Age_cat;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    cluster PSU_VAR;
    weight TRMFCTR;
    class EDUC (ref="(4) 16 + YEARS") / param=ref;
    model Low_Birth_Wt (event="Yes") = EDUC;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    cluster PSU_VAR;
    weight TRMFCTR;
    class MARITAL1 (ref="(2) NOT MARRIED") / param=ref;
    model Low_Birth_Wt (event="Yes") = MARITAL1;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    cluster PSU_VAR;
    weight TRMFCTR;
    class IAQ_7 (ref="(2) NO") / param=ref;
    model Low_Birth_Wt (event="Yes") = IAQ_7;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    cluster PSU_VAR;
    weight TRMFCTR;
    class ALLPREG (ref="(2) NO") / param=ref;
    model Low_Birth_Wt (event="Yes") = ALLPREG;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    cluster PSU_VAR;
    weight TRMFCTR;
    class I_RACETH (ref="(1) WHITE") Age_cat (ref="25/2") EDUC (ref="(4) 16 + YEARS") MARITAL1 (ref="(2) NOT MARRIED") IAQ_7 (ref="(2) NO") ALLPREG (ref="(2) NO") / param=ref;
    model Low_Birth_Wt (event="Yes") = I_RACETH Age_cat EDUC MARITAL1 IAQ_7 ALLPREG / DF=INFINITY link = logit ;
run;

/* Unadjusted Logistic Regression for Low_Birth_Wt */
proc logistic data=Exam.da2835p1_g;
    class I_RACETH (ref="(1) WHITE") Age_cat (ref="25/2") EDUC (ref="(4) 16 + YEARS") MARITAL1 (ref="(2) NOT MARRIED") IAQ_7 (ref="(2) NO") ALLPREG (ref="(2) NO") / param=ref;
    model Low_Birth_Wt (event="Yes") = I_RACETH Age_cat EDUC MARITAL1 IAQ_7 ALLPREG /  link = logit lackfit rsq expb stb OUTROC = ROC;
    ROC;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    weight TRMFCTR;
    class I_RACETH (ref="(1) WHITE") / param=ref;
    model IQ2901 (event="(1) Yes") = I_RACETH;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    weight TRMFCTR;
    class Age_cat (ref="25/2") / param=ref;
    model IQ2901 (event="(1) Yes") = Age_cat;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    weight TRMFCTR;
    class MARITAL1 (ref="(2) NOT MARRIED") / param=ref;
    model IQ2901 (event="(1) Yes") = MARITAL1;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    weight TRMFCTR;
    class IAQ_7 (ref="(2) NO") / param=ref;
    model IQ2901 (event="(1) Yes") = IAQ_7;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    weight TRMFCTR;
    class ALLPREG (ref="(2) NO") / param=ref;
    model IQ2901 (event="(1) Yes") = ALLPREG;
run;
...
proc surveylogistic data=Exam.da2835p1_g;
    ...
    cluster PSU_VAR;
    weight TRMFCTR;
    class I_RACETH (ref="(1) WHITE") Age_cat (ref="25/2") MARITAL1 (ref="(2) NOT MARRIED") ALLPREG (ref="(2) NO")/ param=ref;
    model IQ2901 (event="(1) Yes") = I_RACETH Age_cat MARITAL1 ALLPREG / link = logit DF=INFINITY;
run;


/* Unadjusted Logistic Regression for Low_Birth_Wt */
proc logistic data=Exam.da2835p1_g;
    class Age_cat (ref="25/2") MARITAL1 (ref="(2) NOT MARRIED") ALLPREG (ref="(2) NO") / param=ref;
    model IQ2901 (event="(1) Yes") = Age_cat MARITAL1 ALLPREG /  link = logit lackfit rsq expb stb OUTROC = ROC;
    ROC;
    ODS OUTPUT ROCASSOCIATION = AUC;
run;
